...
@RestController
@RequestMapping("/b")
public class AsyncaController {

    private static final Logger LOGGER = LoggerFactory.getLogger(AsyncaController.class);
     ...
     * @return
     */
    @GetMapping(value = "/btestCallable")
